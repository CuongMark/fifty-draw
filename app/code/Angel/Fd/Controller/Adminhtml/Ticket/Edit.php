...
class Edit extends \Angel\Fd\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Angel\Fd\Model\Ticket::class);
        ...
        $this->_coreRegistry->register('angel_fd_ticket', $model);
