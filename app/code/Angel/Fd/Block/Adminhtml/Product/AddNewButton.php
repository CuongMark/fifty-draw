...
namespace Angel\Fd\Block\Adminhtml\Product;
...
class AddNewButton extends GenericButton implements ButtonProviderInterface
{
    ...
    {
        return [
            'label' => __('Add New 50/50 Raffle'),
            'on_click' => sprintf("location.href = '%s';", $this->_getProductCreateUrl(\Angel\Fd\Model\Product\Type\Fd::TYPE_ID)),
            'class' => 'primary',
            'id' => 'add',
            'sort_order' => 10
        ];
